                  ...
                  <v-col class="py-1" cols="12" md="5">
                    <v-card width="250" height="250" class="p-2 m-2">
                      <v-img
                        ...
                        :src="
                          form.picture
                            ? 'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/storage/files/vet/products/' + form.picture
                            : 'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/Settings/a1.jpg'
                        "
                      >
                      </v-img>
                      <v-card-actions>
