<template>
                ...
                <v-row>
                  <v-col class="py-1" cols="12"   md="5">
                          ...
                          <v-img
                            ...
                            :src="
                              form.picture
                                ? 'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/storage/files/vet/services/' + form.picture
  ...
  <v-textarea
                    ...
                    >
                      <template slot="label">
                        <div style="font-size: 14px;">Service Description</div>
                      </template>
                    </v-textarea>
   ...
   <v-text-field
                    ...
                    >
                      <template slot="label">
                        <div style="font-size: 14px;">Service Fee / Amount</div>
                      </template>
                    </v-text-field>
                    ...
                    >
                      <template slot="label">
                        <div style="font-size: 14px;">Handle By</div>
                      </template>
                    </v-text-field>
                      </v-col>
                    </v-row>
