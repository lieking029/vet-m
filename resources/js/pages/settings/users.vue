              ...
              <v-col cols="12" lg="4">
                <v-card width="200" height="200" class="p-2 m-2">
                  <v-img
                    width="190"
                    height="190"
                    :src="(form.picture? 'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/storage/files/vet/user/'+form.picture :'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/profile.png')"
                  >
