          ...
          <v-row >
            <v-col  >
              <v-img
                contain
                v-if="!active"
                :src="n.picture?'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/storage/files/vet/pets/picture/' + n.picture:'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/Pets/a1.jpg'"
