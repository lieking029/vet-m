...
export default {
  ...
  data: () => ({
    ...
    btns: [
      { name: "Orders", img: "https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/Reports/a1.png", route: "a", param1: 0 },
      { name: "Pets", img: "https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/Reports/a2.png", route: "b", param1: 0 },
      { name: "Animals", img: "https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/Reports/a5.png", route: "c", param1: 0 },
      { name: "Appointments", img: "https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/Reports/a3.png", route: "d", param1: 0 },
      { name: "Clients", img: "https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/Reports/a4.png", route: "e", param1: 0 },
    ],
  }),
  created() {
    if (this.user) {
