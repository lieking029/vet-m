<template>
  <div>
                      ...
                      <v-col cols="12" lg="4">
                        <v-card width="200" height="200" class="p-2 m-2">
                          <v-img
                            ...
                            :src="
                              form.picture
                                ? 'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/storage/files/vet/animal/' + form.picture
    ...
    <v-slide-group v-else   show-arrows>
      <v-slide-item v-for="(n, k) in data" :key="k"  >
        <v-card
          :color="active ? 'primary' : 'blue lighten-1'"
          class="ma-4"
          height="420"
          width="400"
        >
          <v-row >
            <v-col  >
              <v-img
                contain
                v-if="!active"
                :src="n.picture?'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/storage/files/vet/pets/'
                 + n.picture:'https://provincial-veterinary-clinic-po9ld.ondigitalocean.app/img/Pets/a1.jpg'"
              ...
              >
               ...
               <v-card-actions>
                  <p class="caption text-white">
                    ...
                    <br />
                    My Owner: {{ n.owner }}<br />
                    Birth date: {{ n.birth_date }}
                  </p>
                  <v-spacer></v-spacer>
                  <v-btn style="text-transform: none;" color="info" small dark @click="sub_editItem(n)"
