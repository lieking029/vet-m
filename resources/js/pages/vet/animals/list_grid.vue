                      ...
                      <v-col cols="12" lg="4">
                        <v-card width="200" height="200" class="p-2 m-2">
                          <v-img
                            ...
                            :src="
                              form.picture
                                ? 'https://walrus-app-tna7x.ondigitalocean.app/storage/files/vet/animal/' + form.picture
          ...
          <v-row >
            <v-col  >
              <v-img
                contain
                v-if="!active"
                :src="n.picture?'https://walrus-app-tna7x.ondigitalocean.app/storage/files/vet/pets/'
                 + n.picture:'https://walrus-app-tna7x.ondigitalocean.app/img/Pets/a1.jpg'"
