              ...
              <v-row>
                <v-col cols="12">
                  ...
                  <v-row>
                    ...
                    </v-col>  <v-col class="py-1" cols="12" xl="12" lg="12">
                      <v-textarea 
                        outlined
                        rows="2"
                        dense
...
export default {
  ...
  data: () => ({
    ...
    header: [
      ...
      { class: "border", text: "Class name", value: "name" },
      { class: "border", text: "Location / Room / Building", value: "location" }, 
  ...
  methods: {
    ...
    async getDropdown() {
      await axios.get("/api/school/class/dropdowns").then((result) => {
    ...
    async store() {
      if (this.$refs.subForm.validate()) {
        await Swal.fire({
          ...
          preConfirm: async () => {
            const { data } = await axios.post("/api/school/class/save", this.form);
            return data;
          },
          ...
          if (result.value) {
            ...
            Swal.fire({
              icon: "success",
              title:
                "The class has been successfully " +
