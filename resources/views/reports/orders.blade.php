...
<body>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <th> <h6>Amount per Quantity</h6> </th>
            <th> <h6>Total Amount</h6> </th> 
            <th> <h6>Order by</h6> </th> 
        </tr>
        <!-- Rows -->
        @foreach ($data as $items)
            <tr>
                <td style="width: auto; text-align: left;"> {{ $items['product']  }} </td>
                <td style="width: auto; text-align: left;"> {{ $items['quantity']  }} </td>
                <td style="width: auto; text-align: left;"> {{ $items['amount']  }} </td>
                <td style="width: auto; text-align: right;"> {{ $items['total_amount']  }} </td> 
                <td style="width: auto; text-align: right;"> {{ $items['user_id']  }} </td> 
               </tr>
        @endforeach
    </table>
